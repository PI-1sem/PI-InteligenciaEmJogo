...
import pi_1sem.persistencia.jogo.RankingDAO;
...
public class TelaRanking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rankingTable.setGridColor(java.awt.Color.WHITE);
        rankingTable.setRowHeight(30);
        rankingTable.setBackground(new java.awt.Color(0, 102, 255));
        rankingTable.setFont(new java.awt.Font("Franklin Gothic Medium", 2, 18)); // NOI18N
        rankingTable.setForeground(new java.awt.Color(255, 255, 255));
        rankingTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Posição", "Nome", "E-mail", "Dinheiro"
            }
        ));
        ...
        jLabel5.setFont(new java.awt.Font("Franklin Gothic Medium", 2, 48)); // NOI18N
        jLabel5.setText("Ranking");

        jLabel6.setIcon(new javax.swing.ImageIcon("src//main//java//pi_1sem//images//rd piscando.png")); // NOI18N

        jLabel7.setFont(new java.awt.Font("Franklin Gothic Medium", 2, 14)); // NOI18N
        jLabel7.setText("Essa tabela tá pequena para tanto talento!");
    ...
    private void listarRanking() {
        try {
            var rankingDao= new RankingDAO();
            DefaultTableModel model = (DefaultTableModel) rankingTable.getModel();
            model.setNumRows(0);


            List<Ranking> rankingTotal = rankingDao.exibirRanking();

            for (Ranking i: rankingTotal) {
           ...
           e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Erro ao listar ranking");
        }
    }
}
